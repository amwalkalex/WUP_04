...
The average score on the WORDSUM test for graduates was a little over 1o. Theres a difference between the average score in Graduate school and the average score in Junior College. Thus further proving that the schooling are different than each other. 
...
There is a significant different between the schooling of all 5 degrees. 
```{r}
...
Based on the chart, LT High School and Graduate are the two degrees that are different from one another. In addition, High School is also different than Graduate.
